...
const Projects = ({ isDarkMode }) => {
    ...
    return (
        <div className="d-flex flex-column" id="projects">
            ...
            <div className="card col-12 mx-auto mb-3" style={cardStyle}>
                ...
                <div id="carouselExampleCaptions" class="carousel slide col-10 col-lg-8 mx-auto">
            ...
            <div className="card col-12 mx-auto mt-3 mb-3" style={cardStyle}>
                ...
                <div id="carouselExampleCaptions2" class="carousel slide col-10 col-lg-8 mx-auto">
                    <div class="carousel-indicators">
            ...
            <hr className="mx-auto" style={hrStyle} />
            <div className="card col-12 mx-auto mt-3 mb-3" style={cardStyle}>
                <h2 className="text-center mx-auto mt-3">FIFA 2026 WorldCup App</h2>
                <h5 className="text-center col-10 mx-auto">This project was made using Django, PostgreSQL, and Bootstrap, it allows the management of teams, players, technical teams and users in the worldcup context.</h5>
                <div id="carouselExampleCaptions3" class="carousel slide col-10 col-lg-8 mx-auto">
                    <div class="carousel-indicators">
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions3" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions3" data-bs-slide-to="1" aria-label="Slide 2"></button>
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions3" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions3" data-bs-slide-to="3" aria-label="Slide 4"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/projects/world1.png" class="d-block mx-auto" style={imgStyle} alt="Login View" />
                            <div class="carousel-caption d-none d-md-block">
                                <h5 style={{color:"red"}}>Home View</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/projects/world2.png" class="d-block mx-auto" style={imgStyle} alt="..." />
                            <div class="carousel-caption d-none d-md-block">
                            <h5 style={{color:"red"}}>Login View</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/projects/world3.png" class="d-block mx-auto" style={imgStyle} alt="..." />
                            <div class="carousel-caption d-none d-md-block">
                            <h5 style={{color:"red"}}>Teams View</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/projects/world4.png" class="d-block mx-auto" style={imgStyle} alt="..." />
                            <div class="carousel-caption d-none d-md-block">
                            <h5 style={{color:"red"}}>Technical Team View</h5>
                            </div>
                        </div>
                    </div>
                ...
                <h4 className="text-center mt-3 mb-3">You can check the source code here: <a href="https://github.com/GeffersonParra/Django_Projects/tree/main/worldcup2026" style={aStyle} ><i class='bx bxl-github'></i> Github Repository</a></h4>
            </div>
            <hr className="mx-auto" style={hrStyle} />
            <div className="card col-12 mx-auto mt-3 mb-5" style={cardStyle}>
                <h2 className="text-center mx-auto mt-3">The Element's Fate</h2>
                <h5 className="text-center col-10 mx-auto">This is an Android game developed using Kotlin with libGDX and Aseprite to build the graphics, its a platform game which allows local multiplayer.</h5>
                <div id="carouselExampleCaptions4" class="carousel slide col-10 col-lg-8 mx-auto">
                    <div class="carousel-indicators">
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions4" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions4" data-bs-slide-to="1" aria-label="Slide 2"></button>
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions4" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        <button type="button" style={indStyle} data-bs-target="#carouselExampleCaptions4" data-bs-slide-to="3" aria-label="Slide 4"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/projects/game1.jpg" class="d-block mx-auto" style={imgStyle} alt="Login View" />
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Home</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/projects/game2.jpg" class="d-block mx-auto" style={imgStyle} alt="..." />
                            <div class="carousel-caption d-none d-md-block">
                            <h5>Stage Selector</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/projects/game3.jpg" class="d-block mx-auto" style={imgStyle} alt="..." />
                            <div class="carousel-caption d-none d-md-block">
                            <h5 style={{color:"black"}}>Gameplay</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="/projects/game4.jpg" class="d-block mx-auto" style={imgStyle} alt="..." />
                            <div class="carousel-caption d-none d-md-block">
                            <h5>Winning screen</h5>
                            </div>
                        </div>
                    </div>
                ...
                <h4 className="text-center mt-3 mb-3">You can check the source code here: <a href="https://github.com/GeffersonParra/Other_Projects/tree/main/The%20Elements%20Fate" style={aStyle} ><i class='bx bxl-github'></i> Github Repository</a></h4>
            </div>
        </div>
    )
}
